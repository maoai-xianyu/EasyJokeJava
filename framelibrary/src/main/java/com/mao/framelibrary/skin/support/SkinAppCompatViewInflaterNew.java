...
/**
 * @author zhangkun
 * @time 2020-04-23 22:48
 * @Description  android-29 的源码 AppCompatViewInflater
 */
public class SkinAppCompatViewInflaterNew {
    ...
    public final View createView(View parent, final String name, @NonNull Context context,
        ...
        // originalContext != context 需要注销---> 和容器有关  有问题
    ...
    private void checkOnClickListener(View view, AttributeSet attrs) {
        ...
        if (handlerName != null) {
            view.setOnClickListener(new SkinAppCompatViewInflaterNew.DeclaredOnClickListener(view, handlerName));
        }
        a.recycle();
    }
