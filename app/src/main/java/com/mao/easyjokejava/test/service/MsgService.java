...
public class MsgService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // 绑定建立链接
        Intent mIntent = new Intent(this, GuardService.class);
    ...
    private ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            LogU.d(" MsgService  连接上");
            ToastUtils.show("MsgService 建立连接");
        }
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                startForegroundService(new Intent(MsgService.this, GuardService.class));
            } else {
                startService(new Intent(MsgService.this, GuardService.class));
            }
            bindService(new Intent(MsgService.this, GuardService.class), conn, Context.BIND_IMPORTANT);
        }
    };
